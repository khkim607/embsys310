...
*******************************************************************************/   
    ...
    EXTERN myCstrAnd       // myCstr defined outside this file.
    EXTERN myCstrAfter       // myCstr defined outside this file.
    EXTERN Print_uint32 // Print_uint32 is defined outside this file.
    EXTERN PrintHex // Print_uint32 is defined outside this file.
...
swapPointersAsm
    ...
    LDR R0,[R0]         // load address of pointer of value of R0(xPtr) into R0    
    BL PrintHex         // print to TeraTerm screen        
    POP {R0,R1,LR}      // Restore R0 , R1 and LR
    
    PUSH {R0,R1,LR}     // save the input argument and return address
    LDR R0,=myCstrAnd   // load (global) address of address of string into R0
    LDR R0,[R0]         // load address of string into R0
    BL  PrintString     // call PrintString to print the string
    POP {R0,R1,LR}      // Restore R0 , R1 and LR

    PUSH {R0,R1,LR}     // save the input argument and return address
    LDR R0,[R1]         // load address of pointer of value of R1(yPtr) into R0    
    BL PrintHex         // print to TeraTerm screen
    POP {R0,R1,LR}      // Restore R0 , R1 and LR    
    ...
    PUSH {R0,R1,LR}     // save the input argument and return address
    LDR R0,=myCstrAfter   // load (global) address of address of string into R0
    LDR R0,[R0]         // load address of string into R0
    BL  PrintString     // call PrintString to print the string
    POP {R0,R1,LR}      // Restore R0 , R1 and LR
